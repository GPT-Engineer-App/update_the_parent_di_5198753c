    ...
    <ChakraProvider theme={theme}>
      <Box bg="white" maxH="100vh">
        ...
        <Flex overflow="hidden" direction={{ base: "column", md: "row" }}>
          {/* Canvas area */}
          <Box flex="2" p={4}>
            <Box style={{ width: "100%", minHeight: "calc(100vh - 64px)", overflow: "hidden", borderRadius: "16px", boxShadow: "0 4px 12px 0 rgba(0, 0, 0, 0.05)" }}>
              <Box style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: "cover", backgroundColor: backgroundColor, width: canvasSize.width, minHeight: canvasSize.height, margin: "0 auto", borderRadius: "inherit", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 12px 0 rgba(0, 0, 0, 0.05)" }}>
